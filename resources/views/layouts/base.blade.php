...
<html lang="en">
  <head>
    ...
    <meta
      name="csrf-token"
      content="MkRqEzTGuoSx6LqJUm0OAKxSgNUYt26wTT7RMUZY"
    />
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('assets/css/vendors/slick/slick.css') }}"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('assets/css/vendors/slick/slick-theme.css') }}"
    />
    <link
      id="color-link"
      rel="stylesheet"
      type="text/css"
      href="{{ asset('assets/css/demo4.css') }}"
    />
    <style>
      .h-logo {
                  ...
                  <div class="main-navbar">
                    <div id="mainnav">
                      ...
                      <ul class="nav-menu">
                        ...
                        <li>
                          <a href="{{route('app.index')}}" class="nav-link menu-title"
                            >Home</a
                          >
                        </li>
                        <li>
                          <a href="{{route('shop.index')}}" class="nav-link menu-title"
                            >Shop</a
                          >
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="about-us.html" class="nav-link menu-title"
                            >About Us</a
                          >
                        </li>
                        <li>
                          <a href="contact-us.html" class="nav-link menu-title"
                            >Contact Us</a
                          >
                        </li>
                        <li>
                          <a href="blog.html" class="nav-link menu-title"
                            >Blog</a
                          >
                        </li>
                      </ul>
              ...
              <div class="footer-contact">
                <div class="brand-logo">
                  <a href="{{route('app.index')}}" class="footer-logo float-start">
                    <img
                      src="asset('assets/images/logo.png')"
                      class="f-logo img-fluid blur-up lazyload"
                      alt="logo"
                    />
                  </a>
                </div>
                <ul class="contact-lists" style="clear: both">
                  <li>
                    <span
                      ><b>phone:</b>
                      <span class="font-light"> +1 0000000000</span></span
                    >
                  </li>
                  <li>
                    <span
                      ...
                      ><span class="font-light">
                        NIT, Faridabad, Haryana, India</span
                      ></span
                    >
                  </li>
                  <li>
              ...
              <div class="footer-links">
                ...
                <div class="footer-content">
                  <ul>
                    ...
                    <li>
                      <a href="shop.html" class="font-dark"
                        >Colorfull Hoodies</a
                      >
                    </li>
                    <li>
