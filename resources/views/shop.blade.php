                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories"
                                                        type="checkbox" value="{{$category->id}}" onchange="filterProductbyCategory(this)"  @if(in_array($category->id, explode(',', $q_categories))) 
                                                    checked="checked" 
                                                @endif>
                                ...
                                <div class="img-wrapper">
                                    ...
                                    <div class="cart-wrap">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="wishlist" onclick="addProductToWishList({{$product->id}},'{{$product->name}}',1,{{$product->regular_price}})">
...
@push('scripts')
    <script>
        ...
        function filterProductbyCategory(categories){
            var categories = '';
